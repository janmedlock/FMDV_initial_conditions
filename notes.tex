...
\begin{equation}
  ...
  = \frac{
    \vec{f}\left(t^{\ell}, \vec{X}^{\ell}\right)
    + \vec{f}\left(t^{\ell - 1}, \vec{X}^{\ell - 1}\right)
  }{2}.
\end{equation}
...
\begin{equation}
  ...
  = \vec{0}.
\end{equation}
If $\vec{f}\left(t^{\ell}, \vec{X}^{\ell}\right)$ is linear in
$\vec{X}^{\ell}$ then equation \eqref{cn_unstructured} may be solved
...
\begin{equation}
  \vec{f}\left(t^{\ell}, \vec{X}^{\ell}\right) =
  \begin{bmatrix}
    b\left(t^{\ell}\right) R^{\ell}
    - \omega M^{\ell}
    - \mu M^{\ell}
    \\
    b\left(t^{\ell}\right) \left(N^{\ell} - R^{\ell}\right)
    + \omega M^{\ell}
    - \beta I^{\ell} S^{\ell}
    - \mu S^{\ell}
    \\
...
or
\begin{equation}
  \mat{\Phi}_0^{\ell} = b(t^{\ell}) \vec{v} \mat{\Phi}^{\ell},
\end{equation}
